...
class StoriesRepositoryTest {
    ...
    fun loadTopStories_withSuccess() = runBlocking {
        ...
        whenever(dataSource.loadTopStories(1)).thenReturn(result)
        ...
        // When loading the top stories
        repository.loadTopStories(1, callback)
    ...
    fun loadTopStories_withError() = runBlocking {
        ...
        whenever(dataSource.loadTopStories(2)).thenReturn(result)
        ...
        // When loading the top stories
        repository.loadTopStories(2, callback)
